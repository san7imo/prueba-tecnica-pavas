    ...
    <section aria-labelledby="bike-detail-title">
      ...
      <div className="detail-grid">
        ...
        <aside className="detail-aside">
          <section className="panel resource-card"><p className="card-label">Propietario actual</p><h2><Link className="text-link text-link--heading" to={`/clients/${bike.client.id}`}>{bike.client.name}</Link></h2><dl><div><dt>Cédula</dt><dd>{bike.client.documentNumber || 'Pendiente'}</dd></div><div><dt>Teléfono</dt><dd>{bike.client.phone}</dd></div><div><dt>Correo</dt><dd>{bike.client.email || 'No registrado'}</dd></div><div><dt>Estado</dt><dd><LifecycleBadge lifecycle={bike.client.lifecycle} /></dd></div></dl></section>
